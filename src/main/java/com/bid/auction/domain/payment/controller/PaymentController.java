...
public class PaymentController {
	...
	@Operation(summary = "PG 서버에서 결제 요청 결과를 받는 웹훅 API", description = """
		...
		""")
	@Parameters({
		@Parameter(name = "imp_uid", description = "PG사에서 부여하는 결제 데이터 고유번호", example = "imp_245402750188"),
	...
	@ApiResponses({
		...
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "USER4001",
